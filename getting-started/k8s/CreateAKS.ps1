param(
    ...
    [Parameter()]
    [ValidateNotNullOrEmpty()]
    [string]$ResourceGroup = 'MVP-Site-docker-demo-v2',

    [Parameter()]
    [ValidateNotNullOrEmpty()]
    [string]$AksName = 'MVP-Site-docker-demo-v2',

    [Parameter()]
    [ValidateNotNullOrEmpty()]
    [string]$AcrName = 'MVPSitedockerdemov2',

    [Parameter(Mandatory = $true)]
    [ValidateNotNullOrEmpty()]
    [string]$AzureWindowsPassword = 'Djy_H9jQpT3ea4.U4AN.ILG-wYTfbIKQ42'
)

#Creating Resource Group
az group create -n $ResourceGroup -l $Region

# check if your desired name for ACR is available
az acr check-name -n $AcrName

# create ACR
az acr create -g $ResourceGroup -n  $AcrName --sku Basic --admin-enabled false
